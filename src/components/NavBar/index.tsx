...
const NavBar: FC = () => {
    ...
    const {cartTotalQuantity, cartItems, cartFromApi} = useAppSelector((state: any) => state.cart);
                        ...
                        <NavContent>
                            ...
                            <>
                                ...
                                <IconBtn onClick={navigateToCart}>
                                    <CartContent>
                                        {isAuth ? cartFromApi?.totalQuantity === 0 && null : cartTotalQuantity === 0 && null}
                                        {isAuth ? cartFromApi?.totalQuantity > 0 && (
                                            <CartItems>
                                                <CartNum>{cartFromApi?.totalQuantity}</CartNum>
                                            </CartItems>
                                        ) : cartTotalQuantity > 0 && (
                                            <CartItems>
